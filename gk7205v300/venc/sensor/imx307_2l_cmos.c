			    ...
			    AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        ...
        */
		g_astimx307_2l_State[ViPipe].u32RHS1_MAX =
			(u32VMAX - g_astimx307_2l_State[ViPipe].u32BRL) * 2 -
			21;
	} else {
				       ...
				       AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
		...
		g_astimx307_2l_State[ViPipe].u32RHS1_MAX =
			...
			g_astimx307_2l_State[ViPipe].u32BRL * 2 - 21;
	} else {
				     ...
				     ISP_SNS_REGS_INFO_S *pstSnsRegsInfo)
{
	...
	if ((pstSnsState->bSyncInit == GK_FALSE) ||
		...
		pstSnsState->astRegsInfo[0].unComBus.s8I2cDev =
			g_aunImx307_2l_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstSnsState->astRegsInfo[0].u32RegNum; i++) {
			...
			pstSnsState->astRegsInfo[0]
				.astI2cData[i]
				.u32AddrByteNum = imx307_2l_addr_byte;
			pstSnsState->astRegsInfo[0]
				.astI2cData[i]
				.u32DataByteNum = imx307_2l_data_byte;
		}
