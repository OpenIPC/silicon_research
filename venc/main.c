...
int main(int argc, const char* argv[]) {
	...
	grp_attr.u32MaxW = sensor_width;
	grp_attr.u32MaxH = sensor_height;
	...
	chn_attr.u32Width = sensor_width;
	chn_attr.u32Height = sensor_height;
	...
	switch (rc_mode) {
		case VENC_RC_MODE_H264AVBR:
			rc_param.stParamH264AVbr.s32MaxReEncodeTimes = 1;
			break;

		case VENC_RC_MODE_H264QVBR:
			rc_param.stParamH264QVbr.s32MaxReEncodeTimes = 1;
			break;

		case VENC_RC_MODE_H264VBR:
			rc_param.stParamH264Vbr.s32MaxReEncodeTimes = 1;
			break;

		case VENC_RC_MODE_H264CBR:
			rc_param.stParamH264Cbr.s32MaxReEncodeTimes = 1;
			break;

		case VENC_RC_MODE_H265AVBR:
			rc_param.stParamH265AVbr.s32MaxReEncodeTimes = 1;
			break;

		case VENC_RC_MODE_H265QVBR:
			rc_param.stParamH265QVbr.s32MaxReEncodeTimes = 1;
			break;

		case VENC_RC_MODE_H265VBR:
			rc_param.stParamH265Vbr.s32MaxReEncodeTimes = 1;
			break;

		case VENC_RC_MODE_H265CBR:
			rc_param.stParamH265Cbr.s32MaxReEncodeTimes = 1;
			break;
	}
