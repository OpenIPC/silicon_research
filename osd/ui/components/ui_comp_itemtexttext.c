...
lv_obj_set_width( cui_itemTextText, lv_pct(14));
lv_obj_set_height( cui_itemTextText, lv_pct(9));
lv_obj_set_x( cui_itemTextText, lv_pct(-9) );
lv_obj_set_y( cui_itemTextText, lv_pct(41) );
...
lv_obj_set_x( cui_Label4, -62 );
lv_obj_set_y( cui_Label4, 0 );
lv_obj_set_align( cui_Label4, LV_ALIGN_TOP_RIGHT );
