...
lv_label_set_text(ui_comp_get_child(ui_Home, UI_COMP_ITEMIMGTEXT_LABEL2),"150m");
...
lv_label_set_text(ui_comp_get_child(ui_TotalVolt, UI_COMP_ITEMIMGTEXT_LABEL2),"3.8V");
...
lv_label_set_text(ui_comp_get_child(ui_CellVolt, UI_COMP_ITEMIMGTEXT_LABEL2),"11.4V");
...
lv_obj_set_x( ui_Current, lv_pct(-9) );
lv_obj_set_y( ui_Current, lv_pct(41) );
lv_label_set_text(ui_comp_get_child(ui_Current, UI_COMP_ITEMTEXTTEXT_LABEL4),"000");
...
lv_obj_set_x( ui_Thermo, lv_pct(-23) );
...
lv_obj_set_x( ui_WifiSignal, lv_pct(-39) );
...
lv_obj_set_x( ui_Navigation, lv_pct(23) );
...
lv_obj_set_x( ui_Time, lv_pct(45) );
lv_obj_set_y( ui_Time, lv_pct(41) );
lv_img_set_src(ui_comp_get_child(ui_Time, UI_COMP_ITEMIMGTEXT_IMAGE4), &ui_img_icon_clock_png);
lv_label_set_text(ui_comp_get_child(ui_Time, UI_COMP_ITEMIMGTEXT_LABEL2),"00:00");
lv_obj_set_style_blend_mode(ui_comp_get_child(ui_Time, UI_COMP_ITEMIMGTEXT_LABEL2), LV_BLEND_MODE_ADDITIVE, LV_PART_MAIN | LV_STATE_DEFAULT);

ui_BitRate = ui_itemTextText_create(ui_mainOSD1);
lv_obj_set_x( ui_BitRate, lv_pct(41) );
lv_obj_set_y( ui_BitRate, lv_pct(34) );
...
lv_obj_set_x( ui_RCSignal, lv_pct(45) );
lv_obj_set_y( ui_RCSignal, lv_pct(20) );

lv_img_set_src(ui_comp_get_child(ui_RCSignal, UI_COMP_ITEMIMGTEXT_IMAGE4), &ui_img_icon_signal_png);
lv_label_set_text(ui_comp_get_child(ui_RCSignal, UI_COMP_ITEMIMGTEXT_LABEL2),"99");
...
lv_obj_set_x( ui_GPS, lv_pct(-39) );
lv_obj_set_y( ui_GPS, lv_pct(-44) );
lv_img_set_src(ui_comp_get_child(ui_GPS, UI_COMP_ITEMIMGTEXT_IMAGE4), &ui_img_icon_gps_png);
lv_img_set_zoom(ui_comp_get_child(ui_GPS, UI_COMP_ITEMIMGTEXT_IMAGE4),220);

lv_label_set_text(ui_comp_get_child(ui_GPS, UI_COMP_ITEMIMGTEXT_LABEL2),"23\n");
...
lv_obj_set_x( ui_flyMode, lv_pct(38) );
lv_obj_set_y( ui_flyMode, lv_pct(27) );
lv_obj_set_align( ui_flyMode, LV_ALIGN_CENTER );
...
lv_label_set_text(ui_StatusText,"FBI Warning");
...
lv_obj_set_x( ui_Throttle, lv_pct(45) );
lv_obj_set_y( ui_Throttle, lv_pct(14) );
lv_img_set_src(ui_comp_get_child(ui_Throttle, UI_COMP_ITEMIMGTEXT_IMAGE4), &ui_img_icon_throttle_png);
lv_label_set_text(ui_comp_get_child(ui_Throttle, UI_COMP_ITEMIMGTEXT_LABEL2),"99");
...
lv_label_set_text(ui_comp_get_child(ui_Altitude, UI_COMP_ITEMIMGTEXT_LABEL2),"150m");
