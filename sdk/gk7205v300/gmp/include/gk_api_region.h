...
GK_S32 GK_API_RGN_AttachToChn(RGN_HANDLE Handle, const MPP_CHN_S *pstChn, const RGN_CHN_ATTR_S *pstChnAttr);
GK_S32 GK_API_RGN_DetachFromChn(RGN_HANDLE Handle, const MPP_CHN_S *pstChn);

GK_S32 GK_API_RGN_SetDisplayAttr(RGN_HANDLE Handle, const MPP_CHN_S *pstChn, const RGN_CHN_ATTR_S *pstChnAttr);
GK_S32 GK_API_RGN_GetDisplayAttr(RGN_HANDLE Handle, const MPP_CHN_S *pstChn, RGN_CHN_ATTR_S *pstChnAttr);

GK_S32 GK_API_RGN_GetCanvasInfo(RGN_HANDLE Handle, RGN_CANVAS_INFO_S *pstCanvasInfo);
GK_S32 GK_API_RGN_UpdateCanvas(RGN_HANDLE Handle);

GK_S32 GK_API_RGN_BatchBegin(RGN_HANDLEGROUP *pu32Group, GK_U32 u32Num, const RGN_HANDLE handle[]);
