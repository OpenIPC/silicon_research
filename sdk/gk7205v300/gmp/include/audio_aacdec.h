...
N/A
*/
GK_S32 AACDecodeFindSyncHeader(HAACDecoder hAACDecoder, GK_U8 **ppInbufPtr, GK_S32 *pBytesLeft);
...
N/A
*/
GK_S32 AACDecodeFrame(HAACDecoder hAACDecoder, GK_U8 **ppInbufPtr, GK_S32 *pBytesLeft, GK_S16 *pOutPcm);
