...
#define ERR_CODE_VGS_NOBUF \
	DEFINE_ERR_CODE(MOD_ID_VGS, EN_ERR_LEVEL_ERROR, EN_ERR_NOBUF)
#define ERR_CODE_VGS_BUF_EMPTY \
	DEFINE_ERR_CODE(MOD_ID_VGS, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)
#define ERR_CODE_VGS_NULL_PTR \
	DEFINE_ERR_CODE(MOD_ID_VGS, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define ERR_CODE_VGS_ILLEGAL_PARAM \
	DEFINE_ERR_CODE(MOD_ID_VGS, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define ERR_CODE_VGS_BUF_FULL \
	DEFINE_ERR_CODE(MOD_ID_VGS, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_FULL)
#define ERR_CODE_VGS_SYS_NOTREADY \
	DEFINE_ERR_CODE(MOD_ID_VGS, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
#define ERR_CODE_VGS_NOT_SUPPORT \
	DEFINE_ERR_CODE(MOD_ID_VGS, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
#define ERR_CODE_VGS_NOT_PERMITTED \
	DEFINE_ERR_CODE(MOD_ID_VGS, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
