...
#define ERR_CODE_GDC_NOBUF \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_NOBUF)
#define ERR_CODE_GDC_BUF_EMPTY \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)
#define ERR_CODE_GDC_NULL_PTR \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define ERR_CODE_GDC_ILLEGAL_PARAM \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define ERR_CODE_GDC_BUF_FULL \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_FULL)
#define ERR_CODE_GDC_SYS_NOTREADY \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
#define ERR_CODE_GDC_NOT_SUPPORT \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
#define ERR_CODE_GDC_NOT_PERMITTED \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
#define ERR_CODE_GDC_BUSY \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)
#define ERR_CODE_GDC_INVALID_CHNID \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_CHNID)
#define ERR_CODE_GDC_CHN_UNEXIST \
	DEFINE_ERR_CODE(MOD_ID_GDC, EN_ERR_LEVEL_ERROR, EN_ERR_UNEXIST)
