...
GK_S32 GK_API_VO_SetUserIntfSyncInfo(VO_DEV VoDev,
				     VO_USER_INTFSYNC_INFO_S *pstUserInfo);

GK_S32 GK_API_VO_SetVideoLayerAttr(VO_LAYER VoLayer,
				   const VO_VIDEO_LAYER_ATTR_S *pstLayerAttr);
GK_S32 GK_API_VO_GetVideoLayerAttr(VO_LAYER VoLayer,
...
GK_S32 GK_API_VO_SetVideoLayerCSC(VO_LAYER VoLayer,
				  const VO_CSC_S *pstVideoCSC);
GK_S32 GK_API_VO_GetVideoLayerCSC(VO_LAYER VoLayer, VO_CSC_S *pstVideoCSC);

GK_S32 GK_API_VO_SetVideoLayerPartitionMode(VO_LAYER VoLayer,
					    VO_PART_MODE_E enPartMode);
GK_S32 GK_API_VO_GetVideoLayerPartitionMode(VO_LAYER VoLayer,
...
GK_S32
GK_API_VO_SetVideoLayerBoundary(VO_LAYER VoLayer,
				const VO_LAYER_BOUNDARY_S *pstLayerBoundary);
GK_S32 GK_API_VO_GetVideoLayerBoundary(VO_LAYER VoLayer,
				       VO_LAYER_BOUNDARY_S *pstLayerBoundary);

GK_S32 GK_API_VO_SetVideoLayerParam(VO_LAYER VoLayer,
				    const VO_LAYER_PARAM_S *pstLayerParam);
GK_S32 GK_API_VO_GetVideoLayerParam(VO_LAYER VoLayer,
				    VO_LAYER_PARAM_S *pstLayerParam);

GK_S32 GK_API_VO_SetVideoLayerDecompress(VO_LAYER VoLayer,
					 GK_BOOL bSupportDecompress);
GK_S32 GK_API_VO_GetVideoLayerDecompress(VO_LAYER VoLayer,
					 GK_BOOL *pbSupportDecompress);

GK_S32 GK_API_VO_SetVideoLayerCrop(VO_LAYER VoLayer,
...
GK_S32 GK_API_VO_GetScreenFrame(VO_LAYER VoLayer, VIDEO_FRAME_INFO_S *pstVFrame,
				GK_S32 s32MilliSec);
GK_S32 GK_API_VO_ReleaseScreenFrame(VO_LAYER VoLayer,
...
GK_S32 GK_API_VO_SetChnAttr(VO_LAYER VoLayer, VO_CHN VoChn,
			    const VO_CHN_ATTR_S *pstChnAttr);
GK_S32 GK_API_VO_GetChnAttr(VO_LAYER VoLayer, VO_CHN VoChn,
...
GK_S32 GK_API_VO_SetChnParam(VO_LAYER VoLayer, VO_CHN VoChn,
			     const VO_CHN_PARAM_S *pstChnParam);
GK_S32 GK_API_VO_GetChnParam(VO_LAYER VoLayer, VO_CHN VoChn,
			     VO_CHN_PARAM_S *pstChnParam);

GK_S32 GK_API_VO_SetChnDisplayPosition(VO_LAYER VoLayer, VO_CHN VoChn,
				       const POINT_S *pstDispPos);
GK_S32 GK_API_VO_GetChnDisplayPosition(VO_LAYER VoLayer, VO_CHN VoChn,
				       POINT_S *pstDispPos);

GK_S32 GK_API_VO_SetChnFrameRate(VO_LAYER VoLayer, VO_CHN VoChn,
				 GK_S32 s32ChnFrmRate);
GK_S32 GK_API_VO_GetChnFrameRate(VO_LAYER VoLayer, VO_CHN VoChn,
				 GK_S32 *ps32ChnFrmRate);

GK_S32 GK_API_VO_GetChnFrame(VO_LAYER VoLayer, VO_CHN VoChn,
			     VIDEO_FRAME_INFO_S *pstFrame, GK_S32 s32MilliSec);
GK_S32 GK_API_VO_ReleaseChnFrame(VO_LAYER VoLayer, VO_CHN VoChn,
...
GK_S32 GK_API_VO_SetZoomInWindow(VO_LAYER VoLayer, VO_CHN VoChn,
				 const VO_ZOOM_ATTR_S *pstZoomAttr);
GK_S32 GK_API_VO_GetZoomInWindow(VO_LAYER VoLayer, VO_CHN VoChn,
				 VO_ZOOM_ATTR_S *pstZoomAttr);

GK_S32 GK_API_VO_GetChnPTS(VO_LAYER VoLayer, VO_CHN VoChn, GK_U64 *pu64ChnPTS);
GK_S32 GK_API_VO_QueryChnStatus(VO_LAYER VoLayer, VO_CHN VoChn,
				VO_QUERY_STATUS_S *pstStatus);

GK_S32 GK_API_VO_SendFrame(VO_LAYER VoLayer, VO_CHN VoChn,
			   VIDEO_FRAME_INFO_S *pstVFrame, GK_S32 s32MilliSec);

GK_S32 GK_API_VO_ClearChnBuf(VO_LAYER VoLayer, VO_CHN VoChn, GK_BOOL bClrAll);

GK_S32 GK_API_VO_SetChnBorder(VO_LAYER VoLayer, VO_CHN VoChn,
			      const VO_BORDER_S *pstBorder);
GK_S32 GK_API_VO_GetChnBorder(VO_LAYER VoLayer, VO_CHN VoChn,
			      VO_BORDER_S *pstBorder);

GK_S32 GK_API_VO_SetChnBoundary(VO_LAYER VoLayer, VO_CHN VoChn,
				const VO_CHN_BOUNDARY_S *pstChnBoundary);
GK_S32 GK_API_VO_GetChnBoundary(VO_LAYER VoLayer, VO_CHN VoChn,
				VO_CHN_BOUNDARY_S *pstChnBoundary);

GK_S32 GK_API_VO_SetChnRecvThreshold(VO_LAYER VoLayer, VO_CHN VoChn,
				     GK_U32 u32Threshold);
GK_S32 GK_API_VO_GetChnRecvThreshold(VO_LAYER VoLayer, VO_CHN VoChn,
				     GK_U32 *pu32Threshold);

GK_S32 GK_API_VO_SetChnRotation(VO_LAYER VoLayer, VO_CHN VoChn,
				ROTATION_E enRotation);
GK_S32 GK_API_VO_GetChnRotation(VO_LAYER VoLayer, VO_CHN VoChn,
				ROTATION_E *penRotation);

GK_S32 GK_API_VO_GetChnRegionLuma(VO_LAYER VoLayer, VO_CHN VoChn,
				  VO_REGION_INFO_S *pstRegionInfo,
				  GK_U64 *pu64LumaData, GK_S32 s32MilliSec);

GK_S32 GK_API_VO_SetWBCSource(VO_WBC VoWBC,
...
GK_S32 GK_API_VO_GetWBCFrame(VO_WBC VoWBC, VIDEO_FRAME_INFO_S *pstVFrame,
			     GK_S32 s32MilliSec);
GK_S32 GK_API_VO_ReleaseWBCFrame(VO_WBC VoWBC,
				 const VIDEO_FRAME_INFO_S *pstVFrame);
...
GK_S32 GK_API_VO_SetGraphicLayerCSC(GRAPHIC_LAYER GraphicLayer,
				    const VO_CSC_S *pstCSC);
GK_S32 GK_API_VO_GetGraphicLayerCSC(GRAPHIC_LAYER GraphicLayer,
				    VO_CSC_S *pstCSC);
...
GK_S32 GK_API_VO_SetChnMirror(VO_LAYER VoLayer, VO_CHN VoChn,
			      VO_MIRROR_MODE_E enMirrorMode);
GK_S32 GK_API_VO_GetChnMirror(VO_LAYER VoLayer, VO_CHN VoChn,
			      VO_MIRROR_MODE_E *penMirrorMode);
