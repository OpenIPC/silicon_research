...
ISP_SNS_STATE_S* g_pastImx307_2l[ISP_MAX_PIPE_NUM] = { GK_NULL };
...
#define IMX307_2L_SENSOR_RESET_CTX(dev) (g_pastImx307_2l[dev] = GK_NULL)
...
typedef struct IMX307_2L_STATE_S {
    GK_U8 u8Hcg;
    GK_U32 u32BRL;
    GK_U32 u32RHS1_MAX;
    GK_U32 u32RHS2_MAX;
    ...
    AE_SENSOR_DEFAULT_S* pstAeSnsDft)
{
    ...
    case IMX307_SENSOR_1080P_30FPS_2t1_WDR_MODE:
        ...
        pstAeSnsDft->u32LinesPer500ms = IMX307_VMAX_1080P60TO30_WDR * 30;
        break;
...
{
    ISP_SNS_STATE_S* pstSnsState = GK_NULL;
    GK_U32 u32HCG = g_astimx307_2l_State[ViPipe].u8Hcg;
    GK_U32 u32Tmp;
...
*/
        if (genFSWDRMode[ViPipe] == ISP_FSWDR_LONG_FRAME_MODE) {
            ...
            u32IntTimeMaxTmp = (u32IntTimeMaxTmp0 < u32IntTimeMaxTmp) ? u32IntTimeMaxTmp0 : u32IntTimeMaxTmp;
            u32IntTimeMaxTmp = (u32IntTimeMaxTmp > (g_astimx307_2l_State[ViPipe].u32RHS1_MAX - 3)) ? (g_astimx307_2l_State[ViPipe]
                                                                                                          .u32RHS1_MAX
                                   - 3)
                                                                                                   : u32IntTimeMaxTmp;
...
static GK_S32 cmos_get_isp_default(VI_PIPE ViPipe, ISP_CMOS_DEFAULT_S* pstDef)
{
    ...
    pstDef->stSensorMode.stDngRawFormat.stCfaRepeatPatternDim
        .u16RepeatPatternDimRows
        = 2;
    pstDef->stSensorMode.stDngRawFormat.stCfaRepeatPatternDim
        .u16RepeatPatternDimCols
        = 2;
...
static GK_VOID cmos_set_pixel_detect(VI_PIPE ViPipe, GK_BOOL bEnable)
{
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        ...
        if (pstSnsState->u8ImgMode == IMX307_SENSOR_720P_30FPS_LINEAR_MODE) {
            u32FullLines_5Fps = (IMX307_VMAX_1080P30_LINEAR * 30) / 5;
        } else if (pstSnsState->u8ImgMode == IMX307_SENSOR_1080P_30FPS_LINEAR_MODE) {
            u32FullLines_5Fps = (IMX307_VMAX_1080P30_LINEAR * 30) / 5;
        } else {
            return;
        }
    ...
    if (bEnable) { /* setup for ISP pixel calibration mode */
        ...
        imx307_2l_write_register(ViPipe, IMX307_VMAX_ADDR,
            u32FullLines_5Fps & 0xFF);
        imx307_2l_write_register(ViPipe, IMX307_VMAX_ADDR + 1,
            (u32FullLines_5Fps & 0xFF00) >> 8);
        imx307_2l_write_register(ViPipe, IMX307_VMAX_ADDR + 2,
            (u32FullLines_5Fps & 0x30000) >> 16);

        imx307_2l_write_register(ViPipe, IMX307_SHS1_ADDR,
            u32MaxIntTime_5Fps & 0xFF);
        imx307_2l_write_register(ViPipe, IMX307_SHS1_ADDR + 1,
            (u32MaxIntTime_5Fps & 0xFF00) >> 8);
        imx307_2l_write_register(ViPipe, IMX307_SHS1_ADDR + 2,
    ...
    if (pstSensorImageMode->f32Fps <= 60) {
        if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
            if (IMX307_RES_IS_720P(pstSensorImageMode->u16Width,
                    pstSensorImageMode->u16Height)) {
                u8SensorImageMode = IMX307_SENSOR_720P_30FPS_LINEAR_MODE;
                ...
                IMX307_2L_ERR_MODE_PRINT(pstSensorImageMode,
                    pstSnsState);
                return GK_FAILURE;
            }
        } else if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
...
static GK_S32 imx307_2l_set_bus_info(VI_PIPE ViPipe,
