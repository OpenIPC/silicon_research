...
VB_BLK GK_API_VB_GetBlock(VB_POOL Pool, GK_U64 u64BlkSize, const GK_CHAR *pcMmzName);
...
GK_S32 GK_API_VB_GetSupplementAddr(VB_BLK Block, VIDEO_SUPPLEMENT_S *pstSupplement);
GK_S32 GK_API_VB_SetSupplementConfig(const VB_SUPPLEMENT_CONFIG_S *pstSupplementConfig);
GK_S32 GK_API_VB_GetSupplementConfig(VB_SUPPLEMENT_CONFIG_S *pstSupplementConfig);
...
GK_S32 GK_API_VB_GetBlockVirAddr(VB_POOL Pool, GK_U64 u64PhyAddr, GK_VOID **ppVirAddr);

GK_S32 GK_API_VB_InitModCommPool(VB_UID_E enVbUid);
GK_S32 GK_API_VB_ExitModCommPool(VB_UID_E enVbUid);

GK_S32 GK_API_VB_SetModPoolConfig(VB_UID_E enVbUid, const VB_CONFIG_S *pstVbConfig);
