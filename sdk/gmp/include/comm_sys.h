...
#define ERR_CODE_SYS_NULL_PTR      DEFINE_ERR_CODE(MOD_ID_SYS, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define ERR_CODE_SYS_NOTREADY      DEFINE_ERR_CODE(MOD_ID_SYS, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
#define ERR_CODE_SYS_NOT_PERM      DEFINE_ERR_CODE(MOD_ID_SYS, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
#define ERR_CODE_SYS_NOMEM         DEFINE_ERR_CODE(MOD_ID_SYS, EN_ERR_LEVEL_ERROR, EN_ERR_NOMEM)
#define ERR_CODE_SYS_ILLEGAL_PARAM DEFINE_ERR_CODE(MOD_ID_SYS, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define ERR_CODE_SYS_BUSY          DEFINE_ERR_CODE(MOD_ID_SYS, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)
#define ERR_CODE_SYS_NOT_SUPPORT   DEFINE_ERR_CODE(MOD_ID_SYS, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
