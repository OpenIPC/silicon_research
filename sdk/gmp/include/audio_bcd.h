...
gk_s32 audio_baby_crying_detection_init(bcd_handle *bcd, gk_s32 sample_rate, const audio_bcd_config *bcd_config);

gk_s32 audio_baby_crying_detection_process(bcd_handle bcd, audio_bcd_process_data *input_data,
